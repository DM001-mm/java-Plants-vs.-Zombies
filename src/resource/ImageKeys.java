...
public class ImageKeys { //双引号用多了很累，于是 就有了下面的手写枚举类
    ...
    public static final String CARD_PEASHOOTER_DISABLED = "card.peashooter.disabled";
    public static final String CARD_SUNFLOWER_DISABLED = "card.sunflower.disabled";
    public static final String CARD_CHERRY_BOMB_DISABLED = "card.cherry_bomb.disabled";
    public static final String CARD_WALLNUT_DISABLED = "card.wallnut.disabled";
    public static final String CARD_SNOW_PEASHOOTER_DISABLED = "card.snow_peashooter.disabled";
    public static final String CARD_POTATO_MINE_DISABLED = "card.potato_mine.disabled";
    ...
    public static final String ANIM_NORMAL_ZOMBIE_DIE_NORMAL = "anim.zombie.normal.die.normal";
    public static final String ANIM_NORMAL_ZOMBIE_DIE_EXPLODE = "anim.zombie.normal.die.explode";
    ...
    public static final String ANIM_CONEHEAD_ZOMBIE_DIE_NORMAL = "anim.zombie.conehead.die.normal";
    public static final String ANIM_CONEHEAD_ZOMBIE_DIE_EXPLODE = "anim.zombie.conehead.die.explode";
    ...
    public static final String ANIM_BUCKETHEAD_ZOMBIE_DIE_NORMAL = "anim.zombie.buckethead.die.normal";
    public static final String ANIM_BUCKETHEAD_ZOMBIE_DIE_EXPLODE = "anim.zombie.buckethead.die.explode";
